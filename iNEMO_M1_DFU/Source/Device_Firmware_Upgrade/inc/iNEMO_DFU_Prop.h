...
#ifndef __INEMO_USB_PROP_H
#define __INEMO_USB_PROP_H
...
/** @defgroup DFU_Processing
  * @{
  */

/** @defgroup DFU_Processing_Prototypes
  * @{
  */
...
/**
  * @}
  */ /* end of group DFU_Processing_Prototypes */
