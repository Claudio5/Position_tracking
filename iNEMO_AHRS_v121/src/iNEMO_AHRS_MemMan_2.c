...
*      FreeRTOS and its Memory Alloc and Memory Free functions.
*
...
/**
* @brief  Memory allocation function remapped in the FreeRTOS one
...
/**
* @brief  Memory de-allocation function remapped in the FreeRTOS one
