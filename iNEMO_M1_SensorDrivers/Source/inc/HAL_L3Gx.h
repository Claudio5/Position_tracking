...
/**
 * @brief This define remaps the communication interface initialization for L3G4200D in a common initialization function that is @ref L3gxCommInit.
 */
#define L3g4200dCommInit        L3gxCommInit
   
/**
 * @brief This define remaps the communication interface initialization for L3GD20 in a common initialization function that is @ref L3gxCommInit.
 */   
...
/**
 * @brief This define remaps the SPI interface of Gyroscopes in the STM32 SPI2.
 */    
#define L3G_SPI                 SPI2

/**
 * @brief This define remaps the L3gxCommInit communication interface initialization in the @ref iNemoSPIInit.
 */    
#define L3gxCommInit()                             iNemoSPIInit(L3G_SPI)
   
/**
 * @brief This define remaps the L3gxBufferRead functions in the @ref iNemoSPIBufferRead.
 */    
#define L3gxBufferRead(pVal,cAddress,nBytes)       iNemoSPIBufferRead(L3G_SPI,pVal,cAddress,nBytes)
   
/**
 * @brief This define remaps the L3gxBufferWrite functions in the @ref iNemoSPIBufferWrite.
 */    
