...
/**
 * @defgroup iNemoI2CDriver     iNemoI2CDriver
 * @brief I2C low level driver for STM32F10x.
 * @{
 */

/**
 * @brief This define is used to enter in critical section.
 */   
#define FORCE_CRITICAL_SEC

/**
 * @brief Address of Data Register of I2C1.
 */    
#define I2C1_DR_Address               0x40005410
   
/**
 * @brief Address of Data Register of I2C2.
 */     
#define I2C2_DR_Address               0x40005810

/**
 * @brief TX DMA Channel of I2C1.
 */     
#define I2C1_DMA_CHANNEL_TX           DMA1_Channel6
   
/**
 * @brief RX DMA Channel of I2C1.
 */    
#define I2C1_DMA_CHANNEL_RX           DMA1_Channel7
   
/**
 * @brief TX DMA Channel of I2C2.
 */    
#define I2C2_DMA_CHANNEL_TX           DMA1_Channel4
   
/**
 * @brief RX DMA Channel of I2C2.
 */    
#define I2C2_DMA_CHANNEL_RX           DMA1_Channel5

/**
 * @brief Define for I2C TX Direction.
 */    
#define I2C_DIRECTION_TX 0
   
/**
 * @brief Define for I2C RX Direction.
 */    
#define I2C_DIRECTION_RX 1

/**
 * @brief Size of DMA Buffer.
 */    
 ...
 * @param  cNumByteToRead: number of bytes to read.
 * @retval None
 */
 ...
 * @param  I2Cx: I2C peripherial to use.
 * @param  cAddr : slave address.
 * @param  pcBuffer : pointer to the buffer  containing the data to be written.
 * @param  cWriteAddr : register internal address to write to.
 * @param  cNumByteToWrite : number of bytes to write.
