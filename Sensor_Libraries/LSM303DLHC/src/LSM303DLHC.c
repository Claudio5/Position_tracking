/**
  ...
  * @version V2.3.0
  * @date    12 April 2012
  * @brief   This file provides a set of functions needed to manage the LSM303DLHC slave.
  * @details
  *
...
/**
* @defgroup LSM303DLHC  LSM303DLHC
* @{
*/
...
* @param  pcReg : buffer where store data
* @retval None
*/
...
* @retval LSMAccFifoStatus (@ref LSMAccFifoStatus)
*/
...
* @param  pxClickInit: pointer to a Click configuration structure @ref LSMAccClickInit
* @retval None.
*/
...
* @retval LSMADataStatus: Data status in a @ref LSMADataStatus bitfields structure.
*/
...
* @param  pfData: pointer to a float buffer where to store data
...
* @retval float: temperature value in float
*/
...
* @retval int16_t: Signed 16-bit Raw Temperature Data
*/
...
* @param xFunctionalState: New state for DATA_READY.
*        This parameter is a @ref LSMFunctionalState
* @retval None
*/
