...
typedef enum
{
  LSM_I1_OVERRUN = 0x02,                /*!< FIFO overrun interrupt on INT1 */
  LSM_I1_WTM = 0x04,                    /*!< FIFO watermark interrupt on INT1 */
  LSM_I1_DRDY2 = 0x08,                  /*!< DRDY2 interrupt on INT1 */
  LSM_I1_DRDY1 = 0x10,                  /*!< DRDY1 interrupt on INT1 */
  LSM_I1_AOI2 = 0x20,                   /*!< AOI2 interrupt on INT1 */
  LSM_I1_AOI1 = 0x40,                   /*!< AOI1 interrupt on INT1 */
  LSM_I1_CLICK = 0x80                   /*!< CLICK interrupt on INT1 */
}LSMAIrq1List;
...
typedef enum
{
  LSM_I2_CLICK = 0x80,                  /*!< CLICK interrupt on PAD2 */
  LSM_I2_INT1 = 0x40,                   /*!< Interrupt 1 on PAD2 */
  LSM_I2_INT2 = 0x20,                   /*!< Interrupt 2 on PAD2 */
  LSM_I2_BOOT = 0x10,                   /*!< Reboot memory content on PAD2 */
  LSM_I2_P2ACT = 0x08,                  /*!< Active staus function on PAD2 */
  LSM_I2_H_LACTIVE = 0x02,              /*!< Interrupt active high/low */
}LSMAIrq2List;
...
typedef struct
{
  LSMFlagStatus X_Da:1;                 /*!< X axis new data available */
  LSMFlagStatus Y_Da:1;                 /*!< Y axis new data available */
  LSMFlagStatus Z_Da:1;                 /*!< Z axis new data available */
  LSMFlagStatus ZYX_Da:1;               /*!< X, Y and Z axis new data available */
  LSMFlagStatus X_Or:1;                 /*!< X axis new data overrun */
  LSMFlagStatus Y_Or:1;                 /*!< Y axis new data overrun */
  LSMFlagStatus Z_Or:1;                 /*!< Z axis new data overrun */
  LSMFlagStatus ZYX_Or:1;               /*!< X, Y and Z axis new data overrun */
}LSMADataStatus;
 ...
 */
/**
 * @brief Accelerometer sensitivity with 2 g full scale [LSB/mg].
 */
#define LSM_Acc_Sensitivity_2g     1.0   
/**
 * @brief Accelerometer sensitivity with 4 g full scale [LSB/mg].
 */
#define LSM_Acc_Sensitivity_4g     0.5   
/**
 * @brief Accelerometer sensitivity with 8 g full scale [LSB/mg].
 */
#define LSM_Acc_Sensitivity_8g     0.25 
/**
 * @brief Accelerometer sensitivity with 16 g full scale [LSB/mg].
 */
#define LSM_Acc_Sensitivity_16g    0.0834
 ...
 */
/**
 * @brief  magnetometer X Y axes sensitivity for 1.3 Ga full scale [LSB/Ga]
 */
#define LSM_Magn_Sensitivity_XY_1_3Ga     1100  
/**
 * @brief  magnetometer X Y axes sensitivity for 1.9 Ga full scale [LSB/Ga]
 */
#define LSM_Magn_Sensitivity_XY_1_9Ga     855   
/**
 * @brief  magnetometer X Y axes sensitivity for 2.5 Ga full scale [LSB/Ga]
 */
#define LSM_Magn_Sensitivity_XY_2_5Ga     670   
/**
 * @brief  magnetometer X Y axes sensitivity for 4 Ga full scale [LSB/Ga]
 */
#define LSM_Magn_Sensitivity_XY_4Ga       450   
/**
 * @brief  magnetometer X Y axes sensitivity for 4.7 Ga full scale [LSB/Ga]
 */
#define LSM_Magn_Sensitivity_XY_4_7Ga     400   
/**
 * @brief  magnetometer X Y axes sensitivity for 5.6 Ga full scale [LSB/Ga]
 */
#define LSM_Magn_Sensitivity_XY_5_6Ga     330   
/**
 * @brief  magnetometer X Y axes sensitivity for 8.1 Ga full scale [LSB/Ga]
 */
#define LSM_Magn_Sensitivity_XY_8_1Ga     230   
/**
 * @brief  magnetometer Z axis sensitivity for 1.3 Ga full scale [LSB/Ga]
 */
#define LSM_Magn_Sensitivity_Z_1_3Ga      980   
/**
 * @brief  magnetometer Z axis sensitivity for 1.9 Ga full scale [LSB/Ga]
 */
#define LSM_Magn_Sensitivity_Z_1_9Ga      760   
/**
 * @brief  magnetometer Z axis sensitivity for 2.5 Ga full scale [LSB/Ga]
 */
#define LSM_Magn_Sensitivity_Z_2_5Ga      600   
/**
 * @brief  magnetometer Z axis sensitivity for 4 Ga full scale [LSB/Ga]
 */
#define LSM_Magn_Sensitivity_Z_4Ga        400   
/**
 * @brief  magnetometer Z axis sensitivity for 4.7 Ga full scale [LSB/Ga]
 */
#define LSM_Magn_Sensitivity_Z_4_7Ga      355   
/**
 * @brief  magnetometer Z axis sensitivity for 5.6 Ga full scale [LSB/Ga]
 */
#define LSM_Magn_Sensitivity_Z_5_6Ga      295   
/**
 * @brief  magnetometer Z axis sensitivity for 8.1 Ga full scale [LSB/Ga] 
 */
#define LSM_Magn_Sensitivity_Z_8_1Ga      205   
 ...
 */
/**
 * @brief  temperature sensitivity [LSB/deg]  
 */
#define LSM_Temp_Sensitivity     8  
