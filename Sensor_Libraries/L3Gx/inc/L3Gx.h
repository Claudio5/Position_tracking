...
typedef enum
{
  L3G_DISABLE = 0,              /*!< Disable */
  L3G_ENABLE = !L3G_DISABLE     /*!< Enable */
}L3GFunctionalState;
...
typedef struct
{
  L3GFlagStatus X_Da:1;         /*!< X axis new data available */
  L3GFlagStatus Y_Da:1;         /*!< Y axis new data available */
  L3GFlagStatus Z_Da:1;         /*!< Z axis new data available */
  L3GFlagStatus ZYX_Da:1;       /*!< X, Y Z axis new data available */
  L3GFlagStatus X_Or:1;         /*!< X axis data overrun */
  L3GFlagStatus Y_Or:1;         /*!< Y axis data overrun */
  L3GFlagStatus Z_Or:1;         /*!< Z axis data overrun */
  L3GFlagStatus ZYX_Or:1;       /*!< X, Y, Z axis data overrun */
}L3GDataStatus;
 ...
 */
/**
 * @brief gyroscope sensitivity with 250 dps full scale [LSB/dps] 
 */
#define L3G_Sensitivity_250dps     (float) 114.285f  	
/**
 * @brief gyroscope sensitivity with 500 dps full scale [LSB/dps] 
 */
#define L3G_Sensitivity_500dps     (float) 57.1429f  	
/**
 * @brief gyroscope sensitivity with 2000 dps full scale [LSB/dps] 
 */   
 ...
 */
/**
 * @brief Mapping of L3gxByteRead in @ref L3gxBufferRead.
 */
#define L3gxByteRead(pVal,cAddress)      L3gxBufferRead(pVal,cAddress,1)
/**
 * @brief Mapping of L3gxByteWrite in @ref L3gxBufferWrite.
 */
...
/**
 * @brief Mapping of L3g4200dConfig in @ref L3gxConfig.
 */
#define L3g4200dConfig 			L3gxConfig
/**
 * @brief Mapping of L3g4200dGetInfo in @ref L3gxGetInfo.
 */
#define L3g4200dGetInfo 		L3gxGetInfo
/**
 * @brief Mapping of L3g4200dFilterConfig in @ref L3gxFilterConfig.
 */
#define L3g4200dFilterConfig 		L3gxFilterConfig
/**
 * @brief Mapping of L3g4200dFilterGetInfo in @ref L3gxFilterGetInfo.
 */
#define L3g4200dFilterGetInfo 		L3gxFilterGetInfo
/**
 * @brief Mapping of L3g4200dLowpower in @ref L3gxLowpower.
 */
#define L3g4200dLowpower 		L3gxLowpower
/**
 * @brief Mapping of L3g4200dSetDataRate in @ref L3gxSetDataRate.
 */
#define L3g4200dSetDataRate 		L3gxSetDataRate
/**
 * @brief Mapping of L3g4200dGetEnumDataRate in @ref L3gxGetEnumDataRate.
 */
#define L3g4200dGetEnumDataRate 	L3gxGetEnumDataRate
/**
 * @brief Mapping of L3g4200dSetFullScale in @ref L3gxSetFullScale.
 */
#define L3g4200dSetFullScale 		L3gxSetFullScale
/**
 * @brief Mapping of L3g4200dGetEnumFullScale in @ref L3gxGetEnumFullScale.
 */
#define L3g4200dGetEnumFullScale 	L3gxGetEnumFullScale
/**
 * @brief Mapping of L3g4200dGetSensitivity in @ref L3gxGetSensitivity.
 */
#define L3g4200dGetSensitivity          L3gxGetSensitivity
/**
 * @brief Mapping of L3g4200dReboot in @ref L3gxReboot.
 */
#define L3g4200dReboot 			L3gxReboot
/**
 * @brief Mapping of L3g4200dReadRawData in @ref L3gxReadRawData.
 */
#define L3g4200dReadRawData 		L3gxReadRawData
/**
 * @brief Mapping of L3g4200dReadAngRate in @ref L3gxReadAngRate.
 */
#define L3g4200dReadAngRate 		L3gxReadAngRate
/**
 * @brief Mapping of L3g4200dReadFifo in @ref L3gxReadFifo.
 */
#define L3g4200dReadFifo 		L3gxReadFifo
/**
 * @brief Mapping of L3g4200dGetDataStatus in @ref L3gxGetDataStatus.
 */
#define L3g4200dGetDataStatus 		L3gxGetDataStatus
/**
 * @brief Mapping of L3g4200dIrq1Config in @ref L3gxIrq1Config.
 */
#define L3g4200dIrq1Config 		L3gxIrq1Config
/**
 * @brief Mapping of L3g4200dIrq2Config in @ref L3gxIrq2Config.
 */
#define L3g4200dIrq2Config 		L3gxIrq2Config
/**
 * @brief Mapping of L3g4200dFifoInit in @ref L3gxFifoInit.
 */
#define L3g4200dFifoInit 		L3gxFifoInit
/**
 * @brief Mapping of L3g4200dFifoGetStatus in @ref L3gxFifoGetStatus.
 */
#define L3g4200dFifoGetStatus 		L3gxFifoGetStatus
/**
 * @brief Mapping of L3g4200dFifo in @ref L3gxFifo.
 */
#define L3g4200dFifo 			L3gxFifo
/**
 * @brief Mapping of L3g4200dSetAxisIrqs in @ref L3gxSetAxisIrqs.
 */
#define L3g4200dSetAxisIrqs 		L3gxSetAxisIrqs
/**
 * @brief Mapping of L3g4200dGetAxisIrqs in @ref L3gxGetAxisIrqs.
 */
#define L3g4200dGetAxisIrqs 		L3gxGetAxisIrqs
/**
 * @brief Mapping of L3g4200dSetThreshold in @ref L3gxSetThreshold.
 */
#define L3g4200dSetThreshold 		L3gxSetThreshold
/**
 * @brief Mapping of L3g4200dReadTemp in @ref L3gxReadTemp.
 */
...
/**
 * @brief Mapping of L3gd20Config in @ref L3gxConfig.
 */
#define L3gd20Config 			L3gxConfig
/**
 * @brief Mapping of L3gd20GetInfo in @ref L3gxGetInfo.
 */
#define L3gd20GetInfo 			L3gxGetInfo
/**
 * @brief Mapping of L3gd20FilterConfig in @ref L3gxFilterConfig.
 */
#define L3gd20FilterConfig 		L3gxFilterConfig
/**
 * @brief Mapping of L3gd20FilterGetInfo in @ref L3gxFilterGetInfo.
 */
#define L3gd20FilterGetInfo 	        L3gxFilterGetInfo
/**
 * @brief Mapping of L3gd20Lowpower in @ref L3gxLowpower.
 */
#define L3gd20Lowpower 			L3gxLowpower
/**
 * @brief Mapping of L3gd20SetDataRate in @ref L3gxSetDataRate.
 */
#define L3gd20SetDataRate 		L3gxSetDataRate
/**
 * @brief Mapping of L3gd20GetEnumDataRate in @ref L3gxGetEnumDataRate.
 */
#define L3gd20GetEnumDataRate 	        L3gxGetEnumDataRate
/**
 * @brief Mapping of L3gd20SetFullScale in @ref L3gxSetFullScale.
 */
#define L3gd20SetFullScale 		L3gxSetFullScale
/**
 * @brief Mapping of L3gd20GetEnumFullScale in @ref L3gxGetEnumFullScale.
 */
#define L3gd20GetEnumFullScale 	        L3gxGetEnumFullScale
/**
 * @brief Mapping of L3gd20GetSensitivity in @ref L3gxGetSensitivity.
 */
#define L3gd20GetSensitivity            L3gxGetSensitivity
/**
 * @brief Mapping of L3gd20Reboot in @ref L3gxReboot.
 */
#define L3gd20Reboot 			L3gxReboot
/**
 * @brief Mapping of L3gd20ReadRawData in @ref L3gxReadRawData.
 */
#define L3gd20ReadRawData 		L3gxReadRawData
/**
 * @brief Mapping of L3gd20ReadAngRate in @ref L3gxReadAngRate.
 */
#define L3gd20ReadAngRate 		L3gxReadAngRate
/**
 * @brief Mapping of L3gd20ReadFifo in @ref L3gxReadFifo.
 */
#define L3gd20ReadFifo 			L3gxReadFifo
/**
 * @brief Mapping of L3gd20GetDataStatus in @ref L3gxGetDataStatus.
 */
#define L3gd20GetDataStatus 	        L3gxGetDataStatus
/**
 * @brief Mapping of L3gd20Irq1Config in @ref L3gxIrq1Config.
 */
#define L3gd20Irq1Config 		L3gxIrq1Config
/**
 * @brief Mapping of L3gd20Irq2Config in @ref L3gxIrq2Config.
 */
#define L3gd20Irq2Config 		L3gxIrq2Config
/**
 * @brief Mapping of L3gd20FifoInit in @ref L3gxFifoInit.
 */
#define L3gd20FifoInit 			L3gxFifoInit
/**
 * @brief Mapping of L3gd20FifoGetStatus in @ref L3gxFifoGetStatus.
 */
#define L3gd20FifoGetStatus 	        L3gxFifoGetStatus
/**
 * @brief Mapping of L3gd20Fifo in @ref L3gxFifo.
 */
#define L3gd20Fifo 			L3gxFifo
/**
 * @brief Mapping of L3gd20SetAxisIrqs in @ref L3gxSetAxisIrqs.
 */
#define L3gd20SetAxisIrqs 		L3gxSetAxisIrqs
/**
 * @brief Mapping of L3gd20GetAxisIrqs in @ref L3gxGetAxisIrqs.
 */
#define L3gd20GetAxisIrqs 		L3gxGetAxisIrqs
/**
 * @brief Mapping of L3gd20SetThreshold in @ref L3gxSetThreshold.
 */
#define L3gd20SetThreshold 		L3gxSetThreshold
/**
 * @brief Mapping of L3gd20ReadTemp in @ref L3gxReadTemp.
 */
