...
/**
 * @brief Resume Structure
 */
struct
{
  __IO RESUME_STATE eState;     /*!< Resume State */  
  __IO uint8_t bESOFcnt;        /*!< ESOF Counter */ 
}ResumeS;
...
/**
  ...
  * @param  eResumeSetVal RESUME_STATE A state machine value (RESUME_STATE)
